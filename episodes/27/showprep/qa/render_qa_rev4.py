#!/usr/bin/env python3
"""Ep27 rev4 render-QA at 1600x900 with Playwright (mirrors render_qa_rev2.py)."""
import asyncio, json, sys, pathlib
from playwright.async_api import async_playwright

DECK = pathlib.Path('/home/henrymascot/weeklyclaw/episodes/27/showprep/revs/deck.rev4.html').resolve()
OUT = pathlib.Path('/home/henrymascot/weeklyclaw/episodes/27/showprep/qa/render-1600x900-rev4')
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        await browser.close()
    if bad:
        print('=== RENDER-QA FAIL (rev4) ===')
        print(json.dumps(bad, indent=2))
        sys.exit(1)
    print('=== RENDER-QA PASS (rev4) ===')
