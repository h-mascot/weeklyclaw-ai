#!/usr/bin/env python3
"""Ep27 rev5 render-QA at 1600x900 with Playwright (mirrors render_qa_rev2.py)."""
import asyncio, json, sys, pathlib
from playwright.async_api import async_playwright

DECK = pathlib.Path('/home/henrymascot/weeklyclaw/episodes/27/showprep/revs/deck.rev5.html').resolve()
OUT = pathlib.Path('/home/henrymascot/weeklyclaw/episodes/27/showprep/qa/render-1600x900-rev5')
...
CANARIES = [
    ...
    ('s-seg-models-flash', 'GLM-5.3-Flash'),
    ('s-seg-openai-cluster', 'Jalape'),
    ('s-seg-openai-cluster', 'AGI by December'),
    ('s-seg-instinct-raise', '$2.5 billion'),
    ('s-seg-robot-cluster', 'robot'),
    ('s-signal-outside', 'Dylan Patel'),
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        await browser.close()
    if bad:
        print('=== RENDER-QA FAIL (rev5) ===')
        print(json.dumps(bad, indent=2))
        sys.exit(1)
    print('=== RENDER-QA PASS (rev5) ===')
